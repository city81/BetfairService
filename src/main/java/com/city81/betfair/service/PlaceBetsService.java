...
public class PlaceBetsService {
	 ...
	 */
	public void placeSmallStakeBackBet(int marketId, int selectionId,
		...
		//
		final long placeBetId = placeBet(BetTypeEnum.B, marketId, selectionId,
		...
		//
		final long updateBetId = updateBet(placeBetId, MAXIMUM_PRICE,
		...
		//
		updateBet(updateBetId, MAXIMUM_PRICE, price, stake, stake,
				betPersistenceType, betPersistenceType);

		//
		// Cancel the original minimum stake bet
		//
		cancelBet(placeBetId);

	}

	public void placeSmallStakeLayBet(int marketId, int selectionId,
			double price, double stake,
			BetPersistenceTypeEnum betPersistenceType) {
		...
		//
		final long placeBetId = placeBet(BetTypeEnum.L, marketId, selectionId,
		...
		// stake bet and the smaller stake bet
		//
		final long updateBetId = updateBet(placeBetId, MINIMUM_PRICE,
		...
		// Update the small stake bet with the supplied price
		//
		updateBet(updateBetId, MINIMUM_PRICE, price, stake, stake,
				betPersistenceType, betPersistenceType);		
	...
	public long placeBet(BetTypeEnum betType, int marketId, int selectionId,
			double price, double stake,
			BetPersistenceTypeEnum betPersistenceType) {
	...
	public long updateBet(long betId, double oldPrice, double newPrice,
